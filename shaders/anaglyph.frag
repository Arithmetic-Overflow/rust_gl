...
// void main() {
//     vec2 pr = v_tex_coords;
//     vec2 pg = v_tex_coords + vec2(0.002);
//     vec2 pb = v_tex_coords - vec2(0.002);

//     float r = texture(tex, pr).r;
//     float g = texture(tex, pg).g;
//     float b = texture(tex, pb).b;
